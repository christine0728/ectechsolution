...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha384-ezBsECznXjVsiCV6z5fuu3uNNy3ZyaKb4Qm0D9xY/9W1cV51Pr5Pwprl1LwCJgBE" crossorigin="anonymous">
...
.nav-item.active {
    ...
    color:  #d4af37; /* Change to the text color you want */
}
            ...
            <div class="card" style ="background: #d4af37">
                ...
                <div class="content">
                  <br><br>
                    ...
                    <h3 style="color: black; font-family: Arial, Helvetica, sans-serif;">{{$service->name}}</h3>
      
                    <a href="#" class="btn-edit" data-toggle="modal" data-target="#modalEdit" data-id="{{$service->id}}" > <button class="btn bg-warning text-dark">Read More</button></a>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card" style ="background: #d4af37">
                ...
                <div class="content">
                  <br><br>   <br><br>   
                    <p class="desc" style="color: black;">{{$promo->title}}</p>
                  
                    <a href="#" class="btn-promo" data-toggle="modal" data-target="#modalP" data-id="{{$promo->id}}" > <button class="btn bg-warning text-dark">Read More</button></a>
    ...
    error: function(xhr, status, error) {
        ...
        if (xhr.status === 404) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Record not found. Please try again later.',
            });
        } else {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'An error occurred while fetching the record. Please try again later.',
            });
        }
    }
});
...
<!-- Modal: modalAbandonedCart-->
<div class="modal fade right" id="modalP" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="true">
  <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-info" role="document">
    <!--Content-->
    <div class="modal-content">
      <!--Header-->
