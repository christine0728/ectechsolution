...
<div class="col-xl-6">
      ...
      <a href="/admin/service" >
                            <div class="card card-stats">
                                ...
                                <span class="material-icons" style="color: green;">build</span>

                                </div>
                                </div>
                                
                                <div class="card-content">
                                    <p class="category"><strong>Service</strong></p>
                                    <h3 class="card-title">{{$service}}</h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                    <i class="material-icons text-info">info</i> Total of service
                                    </div>
                                </div>
                            </div>
                            </a>
                        ...
                        <a href="/admin/item" >
                            <div class="card card-stats">
                                ...
                                <span class="material-icons" style="color: green;">inventory_2</span>
                                ...
                                <div class="card-content">
                                    <p class="category"><strong>Inventory</strong></p>
                                    <h3 class="card-title">{{$inventory}}</h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                    <i class="material-icons text-info">info</i> Total of inventory
                                    </div>
                                </div>
                            </div>
                            </a>
                    ...
                    <a href="/admin/appointment-list" >
                            <div class="card card-stats">
                                ...
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons text-info">info</i> Received Request
                                        <a href="#pablo"></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                          <a href="/admin/appointment-accepted">
                            <div class="card card-stats">
                                <div class="card-header">
                                <div class="icon icon-warning">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                        <a href="/admin/appointment-declined">
                            <div class="card card-stats">
                                <div class="card-header">
                                <div class="icon icon-success">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                        <a href="/admin/appointment-pending">
                            <div class="card card-stats">
                                <div class="card-header">
                                <div class="icon icon-warning">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const serviceChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Count by Service', // Set the desired legend label here
