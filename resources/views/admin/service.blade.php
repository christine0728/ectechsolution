...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Service</h4></h4>
                  <button type="button" class="btn" data-toggle="modal" data-target="#modalAdd" style="background: #e5b80b;">New Service</button>
                                        ...
                                        <tbody>
                                           ...
                                           @forelse ($services as $service)
                                                  <tr>
                                                      ...
                                                      <a href="#" class="btn-edit" data-toggle="modal"  data-id="{{ $service->id }}" data-target="#modalEdit" ><i style="color:white;" class="fa fa-edit"></i></a>
                                                                  </button>
                                                                  <button type="button" class="btn btn-danger btn-sm" >
                                                      <a href="#" onclick="confirmDelete('{{ $service->id }}')"><i style="color:white;" class="fas fa-trash-alt"></i></a>
                                                      </button>
                                                    </td>
                                                  </tr>
                                              @empty
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          ...
          error: function (error) {
            ...
            Swal.fire(
              'Error!',
              'You cannot delete the service. It was already in use.',
              'error'
            );
          }
        });
                          ...
                          <form method="post" action="/admin/save-services"  enctype="multipart/form-data">
                                ...
                                <div class="card-content">
                                   <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Enter the Service Name" required>
                                            @error('name')
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="custom-file">
                                              ...
                                              <label class="custom-file-label" for="image" id="selectedFileName">Select image file...</label>
                                          </div>  @error('image')
                                                                        <div class="text-red-600 text-sm">{{ $message }}</div>
                                          @enderror
                                      </div>
                                      <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="duration" id="duration" placeholder="Enter the Duration" required>
                                        @error('duration')
                                              <div class="text-red-600 text-sm">{{ $message }}</div>
                                              @enderror
                                        </div> <p></p>
        ...
        <div class="modal-content">
            ...
            <form action="/admin/update-service" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="serviceName" class="req-label">Service Name</label>
                    ...
                    <div class="form-group">
                        <label for="serviceContact" class="req-label">Description</label>
                    ...
                    <div class="form-group">
                        <label for="serviceAddress" class="req-label">Price</label>
...
<script>
    ...
    function updateFileName() {
        ...
        label.textContent = input.files[0] ? input.files[0].name : 'Select image file...';
    }
</script>